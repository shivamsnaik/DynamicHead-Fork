...
def build_swint_backbone(cfg, input_shape):
    ...
    return SwinTransformer(
        ...
        qkv_bias=True,
        qk_scale=None,
        drop_rate=MODEL.SWINT.DROPOUT_RATE,
        attn_drop_rate=MODEL.SWINT.ATTN_DROP_RATE,
...
@BACKBONE_REGISTRY.register()
def build_retinanet_swint_fpn_dyhead_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
...
@BACKBONE_REGISTRY.register()
def build_swint_fpn_dyhead_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
